...
By default, the registrations' config file is set to create all the registrations for all entities. If you don't need a registration, you can edit the `./onboarding/custom/registrations.json` file.
