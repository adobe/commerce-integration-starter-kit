vi.mock("#src/order/external/shipment-created/validator");

import { validateData } from "#src/order/external/shipment-created/validator";

vi.mock("#src/order/external/shipment-created/transformer");

vi.mock("#src/order/external/shipment-created/sender");
...
import * as action from "#src/order/external/shipment-created/index";
import { sendData } from "#src/order/external/shipment-created/sender";
