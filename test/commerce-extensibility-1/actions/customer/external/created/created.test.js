vi.mock("#src/customer/external/created/validator");

import { validateData } from "#src/customer/external/created/validator";

vi.mock("#src/customer/external/created/sender");
...
import * as action from "#src/customer/external/created/index";
import { sendData } from "#src/customer/external/created/sender";

describe("Given customer external created action", () => {
