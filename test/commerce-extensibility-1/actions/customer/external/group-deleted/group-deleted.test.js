vi.mock("#src/customer/external/group-deleted/validator");

import { validateData } from "#src/customer/external/group-deleted/validator";
...
describe("Given customer group external deleted action", () => {
