...
jest.mock('../../../../../actions/product/external/created/validator')
const { validateData } = require('../../../../../actions/product/external/created/validator')

jest.mock('../../../../../actions/product/external/created/sender')
const { sendData } = require('../../../../../actions/product/external/created/sender')

const action = require('../../../../../actions/product/external/created')
...
describe('Product external created', () => {
