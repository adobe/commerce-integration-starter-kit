...
jest.mock('../../../../../actions/product/external/deleted/validator')
const { validateData } = require('../../../../../actions/product/external/deleted/validator')

jest.mock('../../../../../actions/product/external/deleted/sender')
const { sendData } = require('../../../../../actions/product/external/deleted/sender')

const action = require('../../../../../actions/product/external/deleted')
...
describe('Product external deleted', () => {
