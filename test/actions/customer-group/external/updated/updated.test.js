...
jest.mock('../../../../../actions/customer-group/external/updated/validator')
const { validateData } = require('../../../../../actions/customer-group/external/updated/validator')

jest.mock('../../../../../actions/customer-group/external/updated/sender')
const { sendData } = require('../../../../../actions/customer-group/external/updated/sender')

const action = require('../../../../../actions/customer-group/external/updated')
