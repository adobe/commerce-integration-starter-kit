...
jest.mock('../../../../../actions/customer-group/external/created/validator')
const { validateData } = require('../../../../../actions/customer-group/external/created/validator')

jest.mock('../../../../../actions/customer-group/external/created/sender')
const { sendData } = require('../../../../../actions/customer-group/external/created/sender')

const action = require('../../../../../actions/customer-group/external/created')
...
describe('Customer Group external created', () => {
