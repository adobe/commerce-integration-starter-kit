...
jest.mock('../../../../../actions/customer-group/external/deleted/validator')
const { validateData } = require('../../../../../actions/customer-group/external/deleted/validator')

jest.mock('../../../../../actions/customer-group/external/deleted/sender')
const { sendData } = require('../../../../../actions/customer-group/external/deleted/sender')

const action = require('../../../../../actions/customer-group/external/deleted')
