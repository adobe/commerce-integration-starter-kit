...
jest.mock('../../../../../actions/customer/external/updated/validator')
const { validateData } = require('../../../../../actions/customer/external/updated/validator')

jest.mock('../../../../../actions/customer/external/updated/sender')
const { sendData } = require('../../../../../actions/customer/external/updated/sender')

const action = require('../../../../../actions/customer/external/updated')
const { HTTP_BAD_REQUEST, HTTP_INTERNAL_ERROR, HTTP_OK } = require('../../../../../actions/constants')

describe('Given customer external updated action', () => {
