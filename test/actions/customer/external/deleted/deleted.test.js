...
jest.mock('../../../../../actions/customer/external/deleted/validator')
const { validateData } = require('../../../../../actions/customer/external/deleted/validator')

jest.mock('../../../../../actions/customer/external/deleted/sender')
const { sendData } = require('../../../../../actions/customer/external/deleted/sender')

const action = require('../../../../../actions/customer/external/deleted')
const { HTTP_BAD_REQUEST, HTTP_INTERNAL_ERROR, HTTP_OK } = require('../../../../../actions/constants')

describe('Given customer external deleted action', () => {
