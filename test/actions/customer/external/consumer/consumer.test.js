...
describe('Customer external consumer', () => {
  ...
  it.each([
    ['be-observer.customer_create', 'customer-backoffice/created', {}],
    ['be-observer.customer_update', 'customer-backoffice/updated', 'data'],
    ['be-observer.customer_delete', 'customer-backoffice/deleted', { one: 'one', two: 'two' }]
  ]
...
describe('Customer Group external consumer', () => {
  ...
  it.each([
    ['be-observer.customer_group_create', 'customer-backoffice/group-created', {}],
    ['be-observer.customer_group_update', 'customer-backoffice/group-updated', 'data'],
    ['be-observer.customer_group_delete', 'customer-backoffice/group-deleted', { one: 'one', two: 'two' }]
  ]
  )('When type is %p, Then forwards the request to the %p action', async (type, action, data) => {
    const params = { type, data }
    const invocation = Openwhisk.prototype.invokeAction = jest.fn()
