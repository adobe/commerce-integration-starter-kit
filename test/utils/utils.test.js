...
describe("stringParameters", () => {
  ...
  test("with fields to be hidden", () => {
    ...
    expect(utils.stringParameters(params)).toEqual(
      expect.stringContaining('"x_secret":"<hidden>"'),
    );
    expect(utils.stringParameters(params)).toEqual(
      expect.stringContaining('"secret_x":"<hidden>"'),
    );
    expect(utils.stringParameters(params)).toEqual(
      expect.stringContaining('"x_secret_x":"<hidden>"'),
    );
    expect(utils.stringParameters(params)).toEqual(
      expect.stringContaining('"x_TOKEN":"<hidden>"'),
    );
    expect(utils.stringParameters(params)).toEqual(
      expect.stringContaining('"TOKEN_x":"<hidden>"'),
    );
    expect(utils.stringParameters(params)).toEqual(
      expect.stringContaining('"x_TOKEN_x":"<hidden>"'),
    );
  });
});
