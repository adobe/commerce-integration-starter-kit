...
async function main (params) {
  const logger = Core.Logger('order-email-created', { level: params.LOG_LEVEL || 'info' })

  logger.info('Start processing request to send email')
  ...
  try {
    ...
    return actionSuccessResponse(`E-mail for order "${params.data.orderId}" sent successfully`)
  } catch (error) {
