...
/**
 * Handles the product save event by dispatching to the created or updated
...
async function main(params) {
  ...
  if (createdAt === updatedAt) {
    logger.info("New product; dispatching to created handler");
    return await created.main(params);
  }
  logger.info("Existing product; dispatching to updated handler");
