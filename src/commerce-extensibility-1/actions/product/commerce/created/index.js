...
async function main(params) {
  const logger = AioLogger("product-commerce-created", {
  ...
  if (createdAt !== updatedAt) {
    logger.info("Product is not newly created; skipping");
    return actionSuccessResponse("Skipped: product is not newly created");
  }
