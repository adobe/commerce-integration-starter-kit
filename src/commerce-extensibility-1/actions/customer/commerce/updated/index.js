...
async function main(params) {
  const logger = Core.Logger("customer-commerce-updated", {
  ...
  if (createdAt === updatedAt) {
    logger.info("Customer was not updated; skipping");
    return actionSuccessResponse("Skipped: customer was not updated");
  }
