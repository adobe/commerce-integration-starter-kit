...
![Bidirectional customer synchronization highlighting customer deletion from the backoffice](ExternalCustomerDeleteSync.png "Backoffice customer deletion synchronization")
